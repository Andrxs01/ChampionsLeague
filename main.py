...
app = FastAPI(title="Champions League 17/18 API", description="API de consulta y gestión de jugadores y equipos de la Champions 17/18", version="1.0")
...
def buscar_jugadores(
    ...
    return jugadores_operations.buscar_jugadores(
        db=db,
        nombre=nombre,
        equipo=equipo,
...
def buscar_equipos(
    ...
    return equipos_operations.buscar_equipos(
        db=db,
        nombre=nombre,
        grupo=grupo,
        pais=pais,
